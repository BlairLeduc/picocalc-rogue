...
You have just finished your years as a
...
| ) | Weapon of some sort. |
| ] | Piece of armor. |
| ! | Flask containing a magic potion. |
| ? | Piece of paper, usually a magic scroll. |
| = | Ring with magic properties. |
| / | Magical staff or wand. |
| ^ | Trap, watch out for these. |
| % | Staircase to other levels. |
| : | Piece of food. |
| A-Z | Uppercase letters represent various inhabitants of the Dungeons of Doom. Watch out, they can be nasty and vicious. |
